...
utils.plotdif(T, x, y, prediction_table, prediction0_table, selected_table, selectedy_table, q_table, outputs_sgd, outputs_q, outputs_unrelated, name = f'Sigmoid_wide_deep_{depth}_width_{width}_point')
